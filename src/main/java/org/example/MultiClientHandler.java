            ...
            while(true){
                ...
                if (!check){
                    if(request.contains("HELLO")){
                        ...
                        out.flush();
                        check = true;
                        System.out.println("[SERVER][MultiClientHandler] Connection verified...");
                    }else{
                        System.out.println("[SERVER][MultiClientHandler] Connection dismissed...");
                        client.close();
                        break;
                    }
                }else if(!fileCheck){
...
//                        yernur txt 45kb 11/22/22 123.123.123.1 9999
                        ...
                        System.out.println("[SERVER][MultiClientHandler] proper file submission! adding them...");
                    ...
                    out.write("BYE BYE".getBytes(StandardCharsets.UTF_8));
                    out.flush();
                    int j=bye1.size();
                    for (int i=0;i<j;i++){
                    ...
                    if(ht.containsKey(arr[1])){
                        LinkedList<String> list = (LinkedList<String>) ht.get("<"+arr[1]);
                        ...
                        System.out.println("[SERVER] File that you are looking for is not found...");
